jQuery(document).ready(function( $ ) {
  ...
  var myDoughnut = new Chart(document.getElementById("intelli").getContext("2d")).Doughnut(doughnutData);
  ...
  var myDoughnut = new Chart(document.getElementById("vscode").getContext("2d")).Doughnut(doughnutData);
